...
public class FrmThemTaiKhoan extends JFrame implements ActionListener {
	...
	public FrmThemTaiKhoan() {
		...
		contentPane.setBorder(new LineBorder(new Color(155, 0, 0)));
		...
		lblUserName.setBounds(60, 90, 100, 20);
		contentPane.add(lblUserName);

		txtTenTaiKhoan = new JTextField();
		txtTenTaiKhoan.setBounds(180, 90, 180, 25);
		contentPane.add(txtTenTaiKhoan);
		txtTenTaiKhoan.setColumns(10);

		JLabel lblNewLabel_1 = new JLabel("Mật khẩu:");
		lblNewLabel_1.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		lblNewLabel_1.setBounds(60, 130, 100, 20);
		contentPane.add(lblNewLabel_1);

		txtMatKhau = new JPasswordField();
		txtMatKhau.setBounds(180, 130, 180, 25);
		...
		lblngKTi.setForeground(Color.blue);
		lblngKTi.setHorizontalAlignment(SwingConstants.CENTER);
		lblngKTi.setFont(new Font("Times New Roman", Font.BOLD, 22));
		lblngKTi.setBounds(10, 11, 380, 40);
		panel.add(lblngKTi);

		btnOk = new JButton("Thêm");
		btnOk.setBackground(Color.white);
		btnOk.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		btnOk.setBounds(180, 180, 80, 30);
