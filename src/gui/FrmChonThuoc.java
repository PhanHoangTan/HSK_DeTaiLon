...
public class FrmChonThuoc extends JFrame implements ActionListener{
	...
	public FrmChonThuoc() {
		...
		lblThuocCoTen = new JLabel("THÔNG TIN THUỐC ");
		lblThuocCoTen.setForeground(Color.blue);
		lblThuocCoTen.setFont(new Font("Times New Roman", Font.PLAIN, 23));
