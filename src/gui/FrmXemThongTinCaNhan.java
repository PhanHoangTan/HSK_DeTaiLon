...
public class FrmXemThongTinCaNhan extends JFrame implements ActionListener{
	...
	public FrmXemThongTinCaNhan() {
		...
		btnCapNhat.setBackground(Color.lightGray);
		...
		pnlThongTinNhanVien.setBackground(new Color(240,240,240));
		...
		pnlThongTinCoBan.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"),
				"Thông tin cá nhân", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		pnlThongTinCoBan.setBounds(10, 27, 1293, 309);
		pnlThongTinCoBan.setBackground(new Color(245,245,245));
		...
		txtTen.setBounds(1100, 25, 160, 20);
		...
		cboGioiTinh.setBounds(811, 72, 82, 23);
		...
		pnlTitle.setBackground(new Color(240,240,240));
