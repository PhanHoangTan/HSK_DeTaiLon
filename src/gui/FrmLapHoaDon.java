...
public class FrmLapHoaDon extends JFrame implements ActionListener,MouseListener,TableModelListener,KeyListener{
	...
	public FrmLapHoaDon() {
		...
		tabbedPane.addTab("Thêm hóa đơn",jp1);



		jp1.add(lblLHD = new JLabel("THÊM HÓA ĐƠN"));
		lblLHD.setFont(new Font("Times New Roman", Font.BOLD, 30));
		lblLHD.setForeground(Color.blue);
		...
		javax.swing.border.Border southborder2=BorderFactory.createLineBorder(Color.red);
		...
		btnThemThuocTim.setHorizontalAlignment(SwingConstants.LEFT);
		btnThemThuocTim.setFont(new Font("Times New Roman", Font.BOLD, 18));
		btnThemThuocTim.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			}
		});
		btnThemThuocTim.setBackground(new Color(255, 255, 255));
		...
		javax.swing.border.Border southborder3=BorderFactory.createLineBorder(Color.red);
		TitledBorder southTitleBorder3=new TitledBorder(southborder3,"Thông tin chi tiết");
		southTitleBorder3.setTitleColor(Color.red);
		...
		btnInHd.setBackground(new Color(255, 255, 255));
