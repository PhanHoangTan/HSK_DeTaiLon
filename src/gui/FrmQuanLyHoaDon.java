...
public class FrmQuanLyHoaDon extends JFrame {
	...
	public FrmQuanLyHoaDon() {
		...
		lblQunLNhn.setFont(new Font("Arial", Font.BOLD, 30));
		...
		pnlHoaDon.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"),
				"Danh s\u00E1ch h\u00F3a \u0111\u01A1n", TitledBorder.LEADING, TitledBorder.TOP, null, Color.BLUE));
		...
		pnlChiTiet.setBackground(new Color(255, 255, 255));
